  ...
  return (
    <div className="page-container fade-in">
      ...
      <Modal
        ...
        title="Log Patient Feedback"
      >
        <form
          onSubmit={submitManualFeedback}
      ...
      >
        <StatCard label="Total Feedback Received" value={feedback.length} />
        <StatCard
                ...
                >
                  ...
                  <TableCell>
                    <div style={{ fontWeight: 500 }}>
                      {new Date(f.received_at).toLocaleDateString(undefined, {
                        month: "short",
                        day: "numeric",
                        year: "numeric",
                      })}
