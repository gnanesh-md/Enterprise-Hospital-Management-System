    ...
    <section className="panel">
      <Tabs>
        ...
        <TabsTrigger
          ...
          title={
            !canManageAccess ? "No permission to manage access control." : ""
          }
        >
          Access Control (RBAC)
        </TabsTrigger>
        <TabsTrigger active={tab === "stats"} onClick={() => setTab("stats")}>
          Statistics
        </TabsTrigger>
      </Tabs>
      ...
      <TabsContent>
              ...
              <form className="grid-form" onSubmit={handleAdd}>
                ...
                <Label>
                  ...
                  <Select
                    value={form.job_role}
                    onChange={(e) =>
                      setForm((p) => ({ ...p, job_role: e.target.value }))
                    }
                    required
                    disabled={!canCreateOrDelete}
                  >
                ...
                <div className="form-actions span-2">
                  ...
                  <Button
                    variant="secondary"
                    type="button"
                    onClick={() => setForm(EMPTY_SIGNUP_FORM)}
                  >
                    Reset
                  </Button>
                </div>
              ...
              >
                ...
                <div className="module-inline-actions">
                  ...
                  <Button
                    variant="secondary"
                    size="sm"
                    onClick={() => void loadEmployees(query)}
                  >
                    Search
                  </Button>
                </div>
                      ...
                      <TableCell>
                        <span
                          style={{
                            ...
                            fontWeight: 600,
                            backgroundColor:
                              emp.status === "active" ? "#DEF7EC" : "#FDE8E8",
                            color:
                              emp.status === "active" ? "#03543F" : "#9B1C1C",
                          }}
                        >
        ...
        {tab === "rbac" && (
          ...
          >
            ...
            <p
              className="muted"
              style={{ margin: "0 0 1.5rem 0", fontSize: "0.875rem" }}
            >
            ...
            <Table>
              ...
              <div>
                {employees.map((emp) => (
                  <TableRow
                    key={`rbac-${emp.employee_id}`}
                    style={{ gridTemplateColumns: "2fr 1fr 3fr 1fr" }}
                  >
                    <TableCell>
                      <div style={{ fontWeight: 600, color: "#1E293B" }}>
                        {emp.full_name || emp.username}
                    ...
                    {editingId === emp.employee_id ? (
                      <TableCell style={{ gridColumn: "1 / -1" }}>
                        ...
                        >
                          <h5 style={{ marginTop: 0, marginBottom: "1rem" }}>
                            Edit Access for {emp.full_name || emp.username}
                          </h5>
                          <Label>
                            User Type
                            <Select
                              value={editForm.user_type || "normal"}
                              onChange={(e) =>
                                setEditForm((p) => ({
                                  ...p,
                                  user_type: e.target
                                    .value as SignupForm["user_type"],
                                }))
                              }
                            >
                          ...
                          {(editForm.user_type || "normal") !== "admin" && (
                            <Label style={{ marginTop: "1rem" }}>
                              ...
                              >
                                Check a module for full access to it, or expand
                                it to grant only specific sub-items.
                              </p>
                              <div
                                      ...
                                      >
                                        <Checkbox
                                          ...
                                          onChange={() =>
                                            setEditForm((p) => ({
                                              ...p,
                                              module_access: toggleWholeModule(
                                                p.module_access || [],
                                                module.value,
                                              ),
                                            }))
                          ...
                          >
                            <Button
                              ...
                              type="button"
                              onClick={() =>
                                void handleEditSave(emp.employee_id)
                              }
                              disabled={!canManageAccess}
                            >
                              Save Access
                      ...
                      <>
                        <TableCell>
                          ...
                          >
                            {USER_TYPE_LABELS[emp.user_type || ""] ||
                              USER_TYPE_LABELS.normal}
                          </Badge>
                        </TableCell>
                        <TableCell>
                          <div
