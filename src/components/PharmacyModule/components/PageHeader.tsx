...
export default function PageHeader({
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-[#E2E8F0] border-t-2 border-t-[#0F766E] p-5 mb-5 flex flex-col md:flex-row md:items-center justify-between gap-4">
      <div>
